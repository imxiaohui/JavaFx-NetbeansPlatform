/*
    Esta clase es un java bean. 

    1) Es serializable.
    2) Tiene un constructor por default
    3) Tiene atributos privados.
    4) Usa nombres estandar para getters y setters
    5) Sobreescribe toString, equals y hash

    Ademas tiene un objeto PropertyChangeSupport, el cual le permitirá tener una
    lista de objetos de la clase PropertyChangeListener e invocar su método 
    propertyChange().
*/
