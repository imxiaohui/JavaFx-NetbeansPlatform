 ...
 */
@ConvertAsProperties(
        dtd = "-//com.asgteach.personeditor//Person//EN",
        autostore = false
)
...
public final class PersonTopComponent extends TopComponent {
    ...
    protected void componentHidden() {
        ...
        TopComponentGroup personGroup = wm.findTopComponentGroup("persongroup");
    ...
    protected void componentShowing() {
        ...
        TopComponentGroup personGroup = WindowManager.getDefault().findTopComponentGroup("persongroup");
        if(personGroup != null){
            personGroup.open();
        }
    }
