 ...
 */
@ConvertAsProperties(dtd = "-//com.asgteach.modes//Output//EN",
autostore = false)
@TopComponent.Description(preferredID = "OutputTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "output", openAtStartup = true)
@ActionID(category = "Window", id = "com.asgteach.modes.OutputTopComponent")
...
public final class OutputTopComponent extends TopComponent {
    ...
    public OutputTopComponent() {
        System.out.println("OutputTopComponent constructor");
        initComponents();
