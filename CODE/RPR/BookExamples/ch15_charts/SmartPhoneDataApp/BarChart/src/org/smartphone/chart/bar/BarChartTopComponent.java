 ...
 */
@ConvertAsProperties(
    dtd = "-//org.smartphone.chart.bar//BarChart//EN",
autostore = false)
...
@ActionID(category = "Window", 
        id = "org.smartphone.chart.bar.BarChartTopComponent")
...
public final class BarChartTopComponent extends TopComponent {
    ...
    private void createScene() {
        try {
            URL location = getClass().getResource("barchart.fxml");
            ...
            controller = (BarChartController) fxmlLoader.getController();
    ...
    private class ChartSaveCapabilityImpl implements ChartSaveCapability {
        ...
        public String getChartName() {
            return Bundle.CTL_BarChartAction();
        }
