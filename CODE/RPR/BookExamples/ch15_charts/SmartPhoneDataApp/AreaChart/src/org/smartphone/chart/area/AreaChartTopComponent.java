 ...
 */
@ConvertAsProperties(
    dtd = "-//org.smartphone.chart.area//AreaChart//EN",
autostore = false)
...
@ActionID(category = "Window", id = "org.smartphone.chart.area.AreaChartTopComponent")
...
public final class AreaChartTopComponent extends TopComponent {
    ...
    private AreaChartController controller;
    ...
    private void createScene() {
        try {
            URL location = getClass().getResource("areachart.fxml");
            ...
            controller = (AreaChartController) fxmlLoader.getController();
    ...
    private class ChartSaveCapabilityImpl implements ChartSaveCapability {
        ...
        public String getChartName() {
            return Bundle.CTL_AreaChartAction();
        }
