 ...
 */
@ConvertAsProperties(
    dtd = "-//org.smartphone.chart.stackedarea//StackedAreaChart//EN",
autostore = false)
@TopComponent.Description(
    preferredID = "StackedAreaChartTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = true)
@ActionID(category = "Window", id = "org.smartphone.chart.stackedarea.StackedAreaChartTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
    displayName = "#CTL_StackedAreaChartAction",
preferredID = "StackedAreaChartTopComponent")
@Messages({
    "CTL_StackedAreaChartAction=StackedAreaChart",
    "CTL_StackedAreaChartTopComponent=StackedAreaChart Window",
    "HINT_StackedAreaChartTopComponent=This is a StackedAreaChart window"
})
public final class StackedAreaChartTopComponent extends TopComponent {
    
    private static JFXPanel chartFxPanel;
    private StackedAreaChartController controller;    
    ...
    private class ChartSaveCapabilityImpl implements ChartSaveCapability {
        ...
        public String getChartName() {
            return Bundle.CTL_StackedAreaChartAction();
        }
