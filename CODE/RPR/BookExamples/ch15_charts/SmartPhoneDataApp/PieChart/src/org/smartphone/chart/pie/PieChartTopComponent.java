 ...
 */
@ConvertAsProperties(
        dtd = "-//org.smartphone.chart.pie//PieChart//EN",
        autostore = false)
...
@ActionID(category = "Window",
        id = "org.smartphone.chart.pie.PieChartTopComponent")
...
public final class PieChartTopComponent extends TopComponent {
    ...
    private void createScene() {
        try {
            URL location = getClass().getResource("piechart.fxml");
            ...
            controller = (PieChartController) fxmlLoader.getController();
    ...
    private class ChartSaveCapabilityImpl implements ChartSaveCapability {
        ...
        public String getChartName() {
            return Bundle.CTL_PieChartAction();
        }
